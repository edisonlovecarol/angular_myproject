...
{
    public class DataDictionay : FullAuditedEntity<long>, IMayHaveTenant
    {
             /// <summary>
        ...
        /// </summary>
        [ForeignKey("ParentId")]
        public virtual DataDictionay Parent { get; set; }
        ...
        /// Children of this OU.
        /// </summary>
        public virtual ICollection<DataDictionay> Children { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationUnit"/> class.
        /// </summary>
        public DataDictionay()
        {
        ...
        public DataDictionay(int? tenantId, string displayName, long? parentId = null)
        {
            TenantId = tenantId;
