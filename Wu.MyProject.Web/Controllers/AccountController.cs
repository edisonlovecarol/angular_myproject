...
using Wu.MyProject.Web.Models.Account;
...
namespace Wu.MyProject.Web.Controllers
{
    public class AccountController : MyProjectControllerBase
    {
        ...
        private System.Exception CreateExceptionForFailedLoginAttempt(AbpLoginResultType result, string usernameOrEmailAddress, string tenancyName)
        {
            switch (result)
            {
                case AbpLoginResultType.Success:
