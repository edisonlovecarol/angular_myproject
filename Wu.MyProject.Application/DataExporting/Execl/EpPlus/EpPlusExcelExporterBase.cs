...
using Wu.MyProject.Net.MimeTypes;

namespace Wu.MyProject.DataExporting.Execl.EpPlus
{
    public abstract class EpPlusExcelExporterBase : MyProjectAppServiceBase, ITransientDependency
    {
